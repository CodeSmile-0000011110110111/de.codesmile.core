...
namespace CodeSmile.Components.Utility
{
	...
	public sealed class LogUnityEvents : MonoBehaviour
	{
		...
		private void OnApplicationFocus(Boolean hasFocus) => LogMethod("OnApplicationFocus");

		private void OnApplicationPause(Boolean pauseStatus) => LogMethod("OnApplicationPause");

		private void OnApplicationQuit() => LogMethod("OnApplicationQuit");

		private void OnAudioFilterRead(Single[] data, Int32 channels) => LogMethod("OnAudioFilterRead");
		...
		private void OnCollisionEnter(Collision other) => LogMethod("OnCollisionEnter");

		private void OnCollisionEnter2D(Collision2D other) => LogMethod("OnCollisionEnter2D");

		private void OnCollisionExit(Collision other) => LogMethod("OnCollisionExit");

		private void OnCollisionExit2D(Collision2D other) => LogMethod("OnCollisionExit2D");

		private void OnCollisionStay(Collision other) => LogMethod("OnCollisionStay");

		private void OnCollisionStay2D(Collision2D other) => LogMethod("OnCollisionStay2D");

		private void OnConnectedToServer() => LogMethod("OnConnectedToServer");

		private void OnControllerColliderHit(ControllerColliderHit hit) => LogMethod("OnControllerColliderHit");
		...
		private void OnJointBreak(Single breakForce) => LogMethod("OnJointBreak");

		private void OnJointBreak2D(Joint2D brokenJoint) => LogMethod("OnJointBreak2D");
		...
		private void OnParticleCollision(GameObject other) => LogMethod("OnParticleCollision");
		...
		private void OnRenderImage(RenderTexture source, RenderTexture destination) => LogMethod("OnRenderImage");
		...
		private void OnTriggerEnter(Collider other) => LogMethod("OnTriggerEnter");

		private void OnTriggerEnter2D(Collider2D other) => LogMethod("OnTriggerEnter2D");

		private void OnTriggerExit(Collider other) => LogMethod("OnTriggerExit");

		private void OnTriggerExit2D(Collider2D other) => LogMethod("OnTriggerExit2D");

		private void OnTriggerStay(Collider other) => LogMethod("OnTriggerStay");

		private void OnTriggerStay2D(Collider2D other) => LogMethod("OnTriggerStay2D");
